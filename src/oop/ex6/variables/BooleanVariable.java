...
/**
 * A concrete variable class for boolean, contains as data member the variable type,
 * 3 different constructors and overrides methods from abstract class.
 */
public class BooleanVariable extends Variable {

    // data members:
    public VariableTypes.DataTypes variableType = VariableTypes.DataTypes.BOOLEAN;
    ...
    public BooleanVariable(String name, Variable otherVariable) throws VariableException{
    ...
    public boolean isOtherVariableAssignmentFits(Variable otherVariable){
        return VariableTypes.isCompatibleWith(VariableTypes.DataTypes.BOOLEAN,
    ...
    public Pattern getPattern(){
        return RegexPatterns.LEGAL_BOOLEAN_PATTERN;
    }
