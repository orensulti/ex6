...
/**
 * A concrete variable class for int, contains as data member the variable type,
 * 3 different constructors and overrides methods from abstract class.
 */
public class IntegerVariable extends Variable {

    // data members:
    public VariableTypes.DataTypes variableType = VariableTypes.DataTypes.INTEGER;
    ...
    public IntegerVariable(String name) throws VariableException{
        super(name);
    }
    public IntegerVariable(String name, String value) throws VariableException{
        super(name, value);
    }
    public IntegerVariable(String name, Variable otherVariable) throws VariableException{
    ...
    public boolean isOtherVariableAssignmentFits(Variable otherVariable){
        return VariableTypes.isCompatibleWith(VariableTypes.DataTypes.INTEGER,
    ...
    public Pattern getPattern(){
        return RegexPatterns.LEGAL_INT_PATTERN;
    }
}
